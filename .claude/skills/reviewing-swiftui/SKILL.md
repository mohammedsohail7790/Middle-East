---
name: reviewing-swiftui
description: Use when writing, reviewing, or debugging SwiftUI code. Checks for modern API usage, maintainability, and performance best practices. Covers SwiftUI views, modifiers, data flow, navigation, animations, accessibility, and Swift concurrency. Triggers on "SwiftUI", "SwiftUI review", "SwiftUI best practices", "iOS views", "SwiftUI performance".
---
...
- For on-device testing, use MobAI's HTTP API (localhost:8686) — do not use xcrun simctl or Xcode Previews automation.
