...
|-----|--------|----------------|
| `Intl.Collator` | Yes | No |
| `Intl.DateTimeFormat` | Yes | No |
| `Intl.NumberFormat` | Yes | No |
| `Intl.getCanonicalLocales()` | Yes | No |
| `Intl.supportedValuesOf()` | Yes | No |
| `Intl.Locale` | No | Yes |
| `Intl.PluralRules` | No | Yes |
| `Intl.RelativeTimeFormat` | No | Yes |
| `Intl.DisplayNames` | No | Yes |
| `Intl.ListFormat` | No | Yes |
| `Intl.Segmenter` | No | Yes |
...
| Custom transition animations | Maybe | Native is more limited |
| Platform-consistent UI | Yes | Less customization |
| Unique/branded design | Consider JS | Native may not support |
