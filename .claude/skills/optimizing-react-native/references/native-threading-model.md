...
|----------|-------|----------|
| Sync method accessing shared state | Caution | Use locks/synchronized |
| Async method accessing UI | No | Dispatch to main thread |
| Multiple async calls to same resource | Caution | Queue or mutex |
| Accessing JS from background | No | Use CallInvoker |
