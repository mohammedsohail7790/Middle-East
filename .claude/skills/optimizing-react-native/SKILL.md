---
name: optimizing-react-native
description: Use when writing, reviewing, or optimizing React Native code. Covers performance, bundle size, animations, FlatList, Hermes, Turbo Modules, and React Native best practices. Triggers on "React Native", "react-native", "RN performance", "FlatList", "FlashList", "Hermes", "Turbo Modules", "bundle size", "React Native optimization".
---
...
> **Note on profiling**: For on-device testing and profiling, use MobAI's HTTP API (localhost:8686) to interact with the device under test. Do not rely on native profiler CLI tools (instruments, android profiler, systrace) from within this skill context.
...
| [native-profiling.md][native-profiling] | MEDIUM | Profiling native code |
