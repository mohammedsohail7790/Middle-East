...
export const FAQ_FULL = [
  { q: "What is Halla AI and how does it work?", a: "Halla AI is a 100% automated AI receptionist. When a customer calls your number, our AI answers instantly. It listens, understands natural speech, asks qualifying questions, schedules appointments, answers FAQs, and takes messages. No live agents. No humans." },
...
export const BLOG_POSTS = [
  ...
  { emoji: "🔗", date: "Feb 20, 2025", title: "7 CRM Integrations That Will Double Your Lead Conversion", desc: "Zapier + Halla AI + these CRMs = automatic follow-up.", href: "/blog/crm-integrations" },
...
export const SOLUTIONS: Record<string, { title: string; subtitle: string; body: string[]; bullets: string[] }> = {
  answering: {
    ...
    body: ["Halla AI answers every call in under 2 rings — 24/7/365. No hold music. No voicemail. Every caller gets a professional, human-sounding AI receptionist."],
  ...
  messages: {
    ...
    body: ["When a human callback is needed, Halla AI captures every detail and sends a full transcript + summary straight to your email."],
  ...
  multilingual: {
    ...
    body: ["Halla AI auto-detects the caller's language and switches seamlessly. Never lose a customer because of a language barrier."],
  ...
  screening: {
    ...
    body: ["Halla AI screens every call, drops robocalls and solicitors in seconds, and flags high-value callers for immediate attention."],
...
export interface IndustryPageContent {
  ...
  /** "What sets Halla AI apart" bullet list */
...
export const INDUSTRY_PAGES: Record<string, IndustryPageContent> = {
  hvac: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and dispatches HVAC technicians 24/7 — built specifically for heating, ventilation, and air conditioning contractors.",
    sections: [
      { heading: "Emergency calls arrive when it's 100 degrees and your phone won't stop ringing", body: "Calls come in when you're in an attic, crawling under a house, or charging a system. Halla AI captures emergency details, books maintenance windows, and sends job summaries instantly to your phone. Our AI handles routine questions about filter changes, system types, seasonal tune-ups, and financing options." },
      { heading: "Fix furnaces while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential job details through structured intake questions. By collecting key information upfront — AC or furnace issue, temperature differential, unusual noises, filter status, system age — the system helps identify and prioritize emergency calls based on your response zones and license types." },
    ],
    differentiators: [
    ...
    faqs: [
      { q: "How does Halla AI handle seasonal demand spikes?", a: "The AI scales automatically. During heat waves or cold snaps, it handles hundreds of simultaneous calls without busy signals. You define priority rules (elderly customers first, no-heat/no-AC emergencies first) and the AI follows them consistently." },
  ...
  plumbing: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and dispatches plumbers 24/7 — built specifically for plumbing contractors and drain specialists.",
    sections: [
      { heading: "Emergency calls arrive when you're knee-deep in a flooded basement", body: "Calls come in when you're snaking a drain, replacing a water heater, or repairing a burst pipe. Halla AI captures emergency details, books service windows, and sends job summaries instantly to your phone. Our AI handles routine questions about service areas, flat-rate pricing, after-hours fees, and availability." },
      { heading: "Fix pipes while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential job details through structured intake questions. By collecting key information upfront — leak location, water shut-off status, pipe material, access details, urgency level — the system helps identify and prioritize emergency calls based on your response zones and license types." },
    ],
    differentiators: [
  ...
  electrical: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and dispatches electricians 24/7 — built specifically for electrical contractors.",
    sections: [
      { heading: "Emergency calls arrive when you're up to your elbows in a panel", body: "Calls come in when you're troubleshooting a short, pulling wire, or finishing a panel upgrade. Halla AI captures emergency details, books service windows, and sends job summaries instantly to your phone. Our AI handles routine questions about service areas, hourly rates, and availability." },
      { heading: "Wire homes while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential job details through structured intake questions. By collecting key information upfront — outage type, panel age, safety concerns, access details — the system helps identify and prioritize emergency calls based on your response zones and license types." },
    ],
    callFlowIntro: "Custom call flows for electrical contractors. Halla AI customizable call flows evaluate caller intent — emergency outage, panel upgrade, new construction wiring, code violation inspection — and apply your predefined criteria for dispatch priority.",
    ...
    faqs: [
      { q: "How does Halla AI handle electrical emergencies after hours?", a: "You define emergency criteria (no power, sparks, burning smell). The AI collects emergency details and immediately notifies your on-call electrician via text with the full job summary." },
  ...
  landscaping: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books landscaping estimates 24/7 — built specifically for lawn care and landscaping professionals.",
    sections: [
      { heading: "Lawn care calls arrive during mowing season afternoons", body: "Calls come in when you're on a zero-turn, trimming hedges, or blowing leaves. Halla AI captures property details, books estimates, and sends lead summaries instantly to your phone. Our AI handles routine questions about mowing schedules, fertilization programs, tree services, and pricing." },
      { heading: "Mow lawns while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential property details through structured intake questions. By collecting key information upfront — lawn size, service type, frequency, special features — the system helps identify and prioritize qualified leads based on your route zones and equipment capabilities." },
    ],
    differentiators: [
    ...
    callFlowIntro: "Custom call flows built for landscaping professionals. Halla AI customizable call flows serve as the technical framework that consistently executes your lead qualification and estimate routing protocols. The routing logic evaluates the caller's intent — weekly mowing, spring cleanup, tree removal, landscape design, snow plowing — and applies your predefined criteria to determine appropriate next steps.",
    qualificationQuestions: [
    ...
    faqs: [
      { q: "How does Halla AI handle different service frequencies?", a: "The AI captures desired frequency (weekly, bi-weekly, monthly, one-time) and can explain your pricing for each option. Recurring services can be set up as automatic weekly bookings." },
  ...
  roofing: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books roof inspections 24/7 — built specifically for roofing contractors and storm damage specialists.",
    sections: [
      { heading: "Storm chase calls arrive when hail is still on the ground", body: "Calls come in when you're on a roof, measuring for replacement, or meeting with insurance adjusters. Halla AI captures damage details, books inspections, and sends lead summaries instantly to your phone. Our AI handles routine questions about shingle types, warranty options, financing, and insurance claim assistance." },
      { heading: "Replace roofs while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential job details through structured intake questions. By collecting key information upfront — leak location, storm date, visible damage, insurance claim status, roof age — the system helps identify and prioritize leads based on your service areas and damage severity." },
    ],
    differentiators: [
  ...
  pestcontrol: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books pest inspections 24/7 — built specifically for exterminators and pest management professionals.",
    sections: [
      { heading: "Emergency calls arrive when a customer spots a rodent or a nest", body: "Calls come in when you're treating a property, mixing chemicals, or finishing route paperwork. Halla AI captures pest details, books treatments, and sends lead summaries instantly to your phone. Our AI handles routine questions about treatment types, safety protocols, recurring plans, and pricing." },
      { heading: "Treat properties while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential pest details through structured intake questions. By collecting key information upfront — pest type, infestation severity, location in home, previous treatments — the system helps identify and prioritize calls based on your service areas and pest control methods." },
    ],
    differentiators: [
  ...
  movers: {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books moving estimates 24/7 — built specifically for moving companies and relocation specialists.",
    sections: [
      { heading: "Moving calls arrive during peak season weekends", body: "Calls come in when you're loading a truck, driving between jobs, or finishing a packing service. Halla AI captures move details, books in-home or virtual estimates, and sends lead summaries instantly to your phone. Our AI handles routine questions about truck sizes, packing services, insurance, and pricing." },
      { heading: "Move belongings while our AI handles the phone", body: "Halla AI greets every customer professionally and captures essential move details through structured intake questions. By collecting key information upfront — move date, home size, distance, special items — the system helps identify and prioritize qualified leads based on your truck capacity and service areas." },
    ],
    differentiators: [
    ...
    callFlowIntro: "Custom call flows built for moving companies. Halla AI customizable call flows serve as the technical framework that consistently executes your lead qualification and estimate routing protocols. The routing logic evaluates the caller's intent — local move, long-distance move, packing only, storage, commercial relocation — and applies your predefined criteria to determine appropriate next steps.",
    qualificationQuestions: [
    ...
    faqs: [
      { q: "How does Halla AI handle large estimates versus small moves?", a: "The AI captures home size and special items. Large moves (4+ bedrooms, pianos, multiple special items) are flagged for priority follow-up. Small moves (studio, 1-bedroom) can be quoted with standard rates without an in-person estimate." },
  ...
  "pool-services": {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books pool service appointments 24/7 — built specifically for pool cleaning and maintenance professionals.",
    sections: [
      { heading: "Pool service calls arrive during spring opening season", body: "Calls come in when you're vacuuming, balancing chemicals, or repairing a pump. Halla AI captures pool details, books service windows, and sends lead summaries instantly to your phone. Our AI handles routine questions about weekly service, chemical programs, equipment repair, and opening/closing dates." },
      { heading: "Clean pools while our AI handles the phone", body: "Halla AI greets every pool owner professionally and captures essential pool details through structured intake questions. By collecting key information upfront — pool type, size, service needed, equipment age — the system helps identify and prioritize qualified leads based on your route zones and service capacity." },
    ],
    differentiators: [
    ...
    callFlowIntro: "Custom call flows built for pool service professionals. Halla AI customizable call flows serve as the technical framework that consistently executes your lead qualification and service routing protocols. The routing logic evaluates the caller's intent — weekly cleaning, green pool, equipment breakdown, opening, closing — and applies your predefined criteria to determine appropriate next steps.",
    qualificationQuestions: [
    ...
    faqs: [
      { q: "How does Halla AI handle green pool emergencies?", a: "The AI recognizes green pool calls as urgent. It captures algae severity, pump status, and access details, then schedules your earliest available treatment visit. The AI can also provide pre-visit instructions (running pump, brushing walls)." },
  ...
  "floor-installers": {
    ...
    intro: "Halla AI provides an intelligent AI receptionist that answers, screens, and books in-home estimates for flooring contractors 24/7 — built specifically for floor installation and restoration professionals.",
    sections: [
      { heading: "Flooring calls arrive during installation projects", body: "Calls come in when you're cutting planks, applying adhesive, or sanding hardwood. Halla AI captures room details, books estimates, and sends lead summaries instantly to your phone. Our AI handles routine questions about material types, installation methods, pricing, and timelines." },
      { heading: "Install floors while our AI handles the phone", body: "Halla AI greets every homeowner professionally and captures essential project details through structured intake questions. By collecting key information upfront — room sizes, material interest, subfloor type, timeline — the system helps identify and prioritize qualified leads based on your installation specialties." },
    ],
    differentiators: [
    ...
    faqs: [
      { q: "How does Halla AI handle different flooring types with different pricing?", a: "You configure separate pricing guidance for each material type. The AI can provide per-square-foot ranges for each material and explain the differences in installation complexity, durability, and maintenance." },
  ...
  cleaning: { title: "Home Cleaning", subtitle: "Quote requests, recurring bookings", intro: "Convert quote requests into booked jobs. Halla AI handles pricing questions, availability, and recurring schedule setup.", useCases: ["One-time deep clean quotes", "Recurring weekly/biweekly booking", "Move-out cleaning intake", "Commercial cleaning leads"] },
  realestate: { title: "Real Estate", subtitle: "Showing requests, buyer qualification", intro: "Every missed showing request is a lost commission. Halla AI qualifies buyers, books showings, and syncs leads to your CRM.", useCases: ["Showing request scheduling", "Buyer qualification questions", "Rental inquiry handling", "Open house lead capture"] },
  all: { title: "50+ Industries", subtitle: "Pre-configured. Ready in minutes.", intro: "Halla AI serves HVAC, plumbing, real estate, salons, auto shops, property management, and dozens more — with industry-tuned AI vocabulary out of the box.", useCases: ["Pre-built industry templates", "Custom vocabulary training", "Industry-specific qualification flows", "Fast 15-minute setup"] },
};
