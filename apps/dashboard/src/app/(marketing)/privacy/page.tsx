...
export const metadata = { title: "Privacy Policy | Halla AI" };

export default function PrivacyPage() {
  return (
    <MarketingShell>
      <PageHero label="Legal" title="Privacy Policy" subtitle="How Halla AI handles your data." />
      <section className="section">
        <div className="container container-sm">
          <p style={{ marginBottom: 20 }}>
            Halla AI Labs collects account, billing, and call metadata needed to operate your AI receptionist.
