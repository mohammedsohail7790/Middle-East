...
import { resendSignupConfirmation, signUpWithEmail } from "./actions";
...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await signUpWithEmail({
      ...
      companyName: fd.get("company") as string,
    });
    ...
    if (result.needsConfirmation) {
      ...
      setNotice(
        `We sent a confirmation link to ${email}. Open the link in your email to verify your account and finish setup.`
      );
      setLoading(false);
      return;
    }
        ...
        {notice ? (
          <div className="mt-6 space-y-3">
            ...
            {pendingEmail && (
              <button
                type="button"
                className="auth-btn auth-btn-primary auth-btn-loading w-full"
                disabled={resending}
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-xs leading-relaxed" style={{ color: "var(--gray-400)" }}>
