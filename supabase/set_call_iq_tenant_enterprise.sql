-- Call IQ tenant (+19193715609) — ensure Enterprise subscription
-- Run in Supabase SQL Editor: https://supabase.com/dashboard/project/btgwgfphgdgnoaqtopwy/sql

-- Link user metadata (login: smd49881@gmail.com)
UPDATE auth.users
...
-- Verify
SELECT vt.company_name, vt.phone_number, u.email, s.plan, s.status
